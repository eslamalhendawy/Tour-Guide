  ...
  return (
    <div className="bg-postage">
      ...
      <div className="md:w-[70%] lg:w-[50%] mx-auto mb-8">
        ...
        <p className="text-white md:text-lg">We are recent graduates from the Faculty of Computers and Informatics at Suez Canal University, specializing in Computer Science. Our passion for innovation has driven us to embark on an exciting journey to create an E-Tourism application. Our goal is to simplify the tourism experience, making it not only more accessible but also incredibly enjoyable.</p>
      </div>
