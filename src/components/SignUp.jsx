      ...
      <Modal open={userData.visibleMenu === "signup"} onClose={handleClose}>
        <div className="flex justify-center items-center h-screen">
          <div className="bg-white p-6 sm:p-12 shadow shadow-white rounded-xl w-[300px] sm:w-[450px]">
            ...
            <div className="mb-3">
              <p className="text-[#a3aab5] mb-2">{t("name&surname")}</p>
              <input onChange={(e) => setName(e.target.value)} className="border border-[#a3aab5] p-2 rounded-lg block w-full focus:outline-none" type="text" placeholder={t("name&surname")} />
            </div>
            <div className="mb-3">
              <p className="text-[#a3aab5] mb-2">{t("email")}</p>
              <input onChange={(e) => setEmail(e.target.value)} className="border border-[#a3aab5] p-2 rounded-lg block w-full focus:outline-none" type="text" placeholder={t("email")} />
            </div>
            <div className="mb-3">
              <p className="text-[#a3aab5] mb-2">{t("password")}</p>
              <input onChange={(e) => setPassword(e.target.value)} className="border border-[#a3aab5] p-2 rounded-lg block w-full focus:outline-none" type="password" placeholder={t("password")} />
            </div>
            <div className="mb-3">
              <p className="text-[#a3aab5] mb-2">{t("confirmpassword")}</p>
              <input onChange={(e) => setConfirmPass(e.target.value)} className="border border-[#a3aab5] p-2 rounded-lg block w-full focus:outline-none" type="password" placeholder={t("confirmpassword")} />
            </div>
